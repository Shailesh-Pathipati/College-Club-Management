...
//        showAlert("Registered for events:\nName: " + name + "\nRoll Number: " + rollNumber);
    ...
    protected void onViewNoticesButtonClick() {
        // Display the notices here.
        showAlert("Notices:\nNotice 1\nNotice 2\nNotice 3");
    }

    @FXML
    protected void onClubPreviousProjectsButtonClick() {
        // Display the club's previous products here.
        showAlert("Club Previous Projects:\nProject 1\nProject 2\nProject 3");
    }
    ...
    protected void onAskQueryButtonClick() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("query-view.fxml"));
